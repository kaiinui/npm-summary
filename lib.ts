...
import { default as tar } from "tinytar";
import { default as pako } from "pako";
import type { GetPackageFilesOptions, Package } from "./types";
import { DEFAULT_INCLUDE_PATTERNS } from "./types";
...
export async function generateSummary(
  ...
  const apiKey = token ||
    process.env.NPM_SUMMARY_GEMINI_API_KEY ||
